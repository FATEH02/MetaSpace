      ...
      <div className="max-w-[600px] flex flex-col items-center">
        <div>
          <h1 className="font-semibold text-3xl">
            Welcome to My Multiplayer Virtual World!
          </h1>
          <p className="w-full text-xl my-6">
            Step into a living, multiplayer virtual world where you can explore,
            interact, and connect in real time. Whether you're here to meet
            friends, discover new spaces, or just have fun, the adventure starts
            now. Jump in and start playing! 🚀
          </p>
        </div>
        <div className="flex flex-col items-center justify-center">
          <Link href="/app">
            <BasicButton className="px-8 py-4 text-xl text-white bg-blue-500 rounded-lg hover:bg-blue-600 focus:ring-2 focus:ring-blue-300">
              Get Started
            </BasicButton>
          </Link>
